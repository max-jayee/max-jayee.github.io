...
| 3 | [사용자/그룹 관리](./user_group/ "https://max-jayee.github.io/software_tools/jenkins/user_group") | 사용자 / 그룹을 관리하는 방법 | |
| 4 | [파이프라인 예시](./pipelines/ "https://max-jayee.github.io/software_tools/jenkins/pipelines") | 빌드 / 배포를 위한 파이프라인 구성 방법 | |